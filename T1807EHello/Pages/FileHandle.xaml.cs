...
namespace T1807EHello.Pages
{
    ...
    {
        private string API_URI = "https://2-dot-backup-server-003.appspot.com/get-upload-token";
        ...
        private async void AddAvatarTrigger(object sender, RoutedEventArgs e)
        {
            ...
            var uploadUrl = client.GetAsync(API_URI).Result.Content.ReadAsStringAsync().Result;
